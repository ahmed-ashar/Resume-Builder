...
import SkillScetion from "../ResumeSections/SkillScetion";
...
const TemplateThree = ({ resumeData, colorPalatte, containerWidth }) => {
  ...
  useEffect(() => {
    ...
    setBaseWidth(actualBasedWidth); // Get the actual base width
      ...
      <div className="flex items-start gap-5 px-2 mb-5">
        ...
        >
          {resumeData.profileInfo.profilePreviewUrl ? (
            ...
            <div
              className="h-[90px] w-[90px] flex items-center justify-center text-5xl rounded-full"
